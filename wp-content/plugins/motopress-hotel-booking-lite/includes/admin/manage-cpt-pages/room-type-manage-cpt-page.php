			...
			case 'capacity':
                ...
                <p>
                    <?php if ($roomType->hasLimitedTotalCapacity()) { ?>
                        <?php _e('Total:', 'motopress-hotel-booking'); ?>&nbsp;<?php echo $roomType->getTotalCapacity(); ?><br />
                    <?php } ?>
                    <?php _e('Adults:', 'motopress-hotel-booking'); ?>&nbsp;<?php echo $roomType->getAdultsCapacity(); ?><br />
                    <?php _e('Children:', 'motopress-hotel-booking'); ?>&nbsp;<?php echo $roomType->getChildrenCapacity(); ?><br />
                    <?php _e('Size:', 'motopress-hotel-booking'); ?>&nbsp;<?php echo !empty($roomSize) ? $roomType->getSize(true) : self::EMPTY_VALUE_PLACEHOLDER; ?>
                </p>
                <?php
				break;
			case 'bed' :
